...
const techStack = [
	...
	},
	{
		...
		items: [
			'Structured Bug/UX Documentation & Reporting',
			'Pytest',
			'GitHub Actions (CI)',
		],
	},
	...
	children: [
		{
			...
			subtitle: 'Front-End Engineer • Accessibility Engineering • B.Tech CS (2026)',
			image: 'https://github.com/yuvrajgovindrao.png',
			description: [
				"I'm Yuvraj Govind Rao, a Front-End Engineer (B.Tech CS, 2026, Galgotias University) based in Greater Noida, UP 201310.",
				'I specialize in building complex, interactive UIs with React and TypeScript, with a strong focus on accessibility engineering, WCAG 2.x (Level AA) standards, WAI-ARIA, and direct screen-reader testing using NVDA.',
				'Experienced in structured technical evaluation and documentation from a formal consumer product trial program at Nothing Technology, translating defects into clear, prioritized reports that product teams acted on.',
				'Skilled in full-stack architecture with Python, FastAPI, AsyncIO microservices, PostgreSQL, SQLite, and modern automated testing/CI with Pytest and GitHub Actions.',
				'Contact: +91 7004890027 | yuvrajgovindrao@gmail.com | github.com/yuvrajgovindrao | linkedin.com/in/yuvrajgovindrao',
				'Actively seeking a Front-End Engineer / Accessibility Engineer role building accessible, high-performance web applications.',
			],
		},
		{
			id: 2,
			...
			description: [
				'Core competencies: Accessibility (WCAG 2.x Level AA, WAI-ARIA, Semantic HTML, NVDA Screen-Reader Testing), Front-End (HTML, CSS, JavaScript, React, TypeScript), Backend & APIs (Python, FastAPI, REST API Design, Microservices, AsyncIO), Testing & Documentation (Structured Bug/UX Documentation, Pytest, GitHub Actions CI), Databases & Tools (PostgreSQL, SQLite, Git/GitHub, Docker Compose).',
				'Featured Projects: macOS-Inspired Interactive Portfolio (React/TypeScript, Zustand window management, GSAP, dark mode, Ask AI), GraphRAG (knowledge graph-enhanced Q&A with Qdrant and Neo4j), and YouTubeRAG (multi-video RAG assistant with pgvector and timestamp citations).',
				'Professional Experience: User Trial Program Participant at Nothing Technology (2024–2025), surfaced 30+ usability/functional/performance defects ahead of public launch, directly influencing 2 pre-launch product decisions.',
				'Education: B.Tech, Computer Science & Engineering (Game Technology) — Galgotias University (2026), CGPA: 7.0 / 10.',
				'Certifications: Google Android Developer Certification.',
			],
		},
	],
} as const satisfies FinderLocation;
