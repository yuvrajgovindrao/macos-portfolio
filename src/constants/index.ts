...
const techStack = [
	...
	},
	{
		...
		items: [
			'Microsoft Azure (App Hosting, Deployment Testing)',
	...
	children: [
		{
			...
			subtitle: 'Software Development Engineer • B.Tech CS (2026)',
			image: 'https://github.com/yuvrajgovindrao.png',
			description: [
				"I'm Yuvraj Govind Rao, a B.Tech Computer Science graduate (2026) and Software Development Engineer based in Greater Noida, UP 201310.",
				'I design, build, and deploy full-stack products end-to-end — REST APIs and SQL/NoSQL databases on the backend, React/TypeScript on the frontend, hosted and tested on Microsoft Azure.',
				'Shipped three personal projects solo, from system architecture through production deployment, including LLM-powered retrieval systems.',
				'Contact: +91 7004890027 | yuvrajgovindrao@gmail.com | github.com/yuvrajgovindrao | linkedin.com/in/yuvrajgovindrao',
				'Actively seeking a Software Development Engineer role building and owning features from whiteboard to production.',
			],
		},
		{
			id: 2,
			...
			subtitle: 'Technical Strengths • Projects • Experience',
			description: [
				'Core competencies: Python, JavaScript, TypeScript, FastAPI, React, LangChain, REST API Design, Microservices, PostgreSQL, SQLite, Qdrant, Azure, Docker.',
				'Featured Projects: GraphRAG (Neo4j + Qdrant hybrid RAG platform), YouTubeRAG (timestamp-grounded video citations), and macOS-Inspired Interactive Portfolio.',
				'Professional Experience: User Trial Program Participant at Nothing Technology (2024–2025), testing unreleased consumer hardware and submitting structured UX, bug, and performance reports.',
				'Education: B.Tech, Computer Science & Engineering (Game Technology) — Galgotias University (2026), CGPA: 7.0 / 10.',
				'Certifications: AWS Certified Data Engineer | Google Android Developer Certification.',
			],
		},
	],
} as const satisfies FinderLocation;
